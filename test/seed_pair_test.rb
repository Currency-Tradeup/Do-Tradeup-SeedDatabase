...
class SeedPairTest < Minitest::Test
  def setup
    ...
    Tradeup::Database::Seeding.connect_to_test_database
    Tradeup::Database::Models::Pair.delete_all # lets the results persist for analysis.
  end
  ...
  def test_that_gbpusd_pair_exists
    ...
    gbp_usd = Tradeup::Database::Models::Pair.where(symbol_one: "GBP",symbol_two: "USD" )
  ...
  def test_that_usdgbp_pair_exists
    ...
    Tradeup::Database::Seeding.connect_to_test_database
    Tradeup::Database::Seeding.seed_pairs from_pairs_list
    usd_gbp = Tradeup::Database::Models::Pair.where(symbol_one: 'USD',symbol_two:'GBP')
